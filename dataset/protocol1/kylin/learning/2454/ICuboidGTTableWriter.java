...
public abstract class ICuboidGTTableWriter implements ICuboidWriter{
    ...
    public void write(long cuboidId, GridTable gridTable) throws IOException {
        ...
        GTScanRequest req = new GTScanRequestBuilder().setInfo(gridTable.getInfo()).setRanges(null).setDimensions(null).setFilterPushDown(null).createGTScanRequest();        IGTScanner scanner = gridTable.scan(req);
