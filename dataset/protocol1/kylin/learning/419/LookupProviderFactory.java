...
public class LookupProviderFactory {
    private static final Logger logger = LoggerFactory.getLogger(LookupProviderFactory.class);    private static Map<String, String> lookupProviderImplClassMap = Maps.newConcurrentMap();
