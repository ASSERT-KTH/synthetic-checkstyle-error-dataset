...
public class KernelTransactionFactory
{
    ...
    static Instances kernelTransactionWithInternals( LoginContext loginContext )
    {
        ...
        KernelTransactionImplementation transaction =                new KernelTransactionImplementation( Config.defaults(), mock( StatementOperationParts.class ), mock( SchemaWriteGuard.class ),
