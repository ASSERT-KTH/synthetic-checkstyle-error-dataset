...
public class ProjectInspector4Checkstyle extends ProjectInspector {
    ...
    public ProjectInspector4Checkstyle
(BuildToBeInspected buildToBeInspected, String workspace, List<AbstractDataSerializer> serializers, List<AbstractNotifier> notifiers) {
