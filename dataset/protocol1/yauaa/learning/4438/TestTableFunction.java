...
public class TestTableFunction {
    ...
    public void testFunction() throws Exception {
        ...
        resultSet.map((MapFunction<Row, String>) row -> {
            assertEquals("Wrong DeviceClass: "           + row.getField(0), row.getField(3), row.getField(1));            assertEquals("Wrong AgentNameVersionMajor: " + row.getField(0), row.getField(4), row.getField(2));
