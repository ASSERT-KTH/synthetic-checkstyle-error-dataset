...
public abstract class MatcherAction implements Serializable {
    ...
    static {
        ...
        CALCULATE_INFORM_PATH.put(MatcherConcatPrefixContext.class,     (action, treeName, tree) ->            calculateInformPath(action, treeName, ((MatcherConcatPrefixContext) tree).matcher()));
