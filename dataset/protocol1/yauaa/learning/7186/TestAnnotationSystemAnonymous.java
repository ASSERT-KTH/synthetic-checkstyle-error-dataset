...
public class TestAnnotationSystemAnonymous {
    ...
    public void testInaccessibleSetter() {
        expectedEx.expect(InvalidParserConfigurationException.class);        expectedEx.expectMessage("Method annotated with YauaaField is not public: inaccessibleSetter");
        record =
            new MyErrorMapper() {
                @YauaaField("DeviceClass")
